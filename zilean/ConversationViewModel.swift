...
final class ConversationViewModel: ObservableObject {
    ...
    private func retrospectivePrompt(for timer: FocusTimerSession) -> String {
        ...
        이 이벤트를 기술적인 형식으로 설명하지 말고, 기존 작업 대화의 맥락을 이어서 한국어로 짧고 부담 없는 회고를 한 번 유도해라. 작업의 성격에 맞춰 무엇을 진행했는지, 막힌 점이 있었는지, 다음 행동이 무엇인지 중 가장 유용한 한두 가지만 물어라. 사용자가 이미 회고 내용을 말한 맥락이면 같은 질문을 반복하지 말고, 회고를 건너뛰거나 다른 요청을 하면 강요하지 마라.
        """
    }
